    ...
    with slim.arg_scope([slim.conv2d, slim.fully_connected],
        ...
        with tf.variable_scope('mobilenet', [images], reuse=reuse):
            with slim.arg_scope([slim.batch_norm, slim.dropout],
                ...
                net = slim.convolution2d(images, round(64 * width_multiplier), [3, 3], stride=2, padding='SAME', scope='conv_1')
                net = _depthwise_separable_conv(net, 96, width_multiplier, sc='conv_ds_2_1')
                ...
                net1 = slim.convolution2d(net, int(256 * width_multiplier), kernel_size=[1, 1], scope='conv6-1')
                net2 = _depthwise_separable_conv(net, 256, width_multiplier, sc='conv_ds_6_1')
                net3 = _depthwise_separable_conv(net2,256, width_multiplier, sc='conv_ds_6_2')
                net3 = _squeeze_excitation_layer(net3, int(256 * width_multiplier), 8)
                net = tf.add_n([net1, net3])
                net = tf.nn.relu6(net)

                net = _depthwise_separable_conv(net, 512, width_multiplier, downsample=True, sc='conv_ds_7')
                net_512_1 = _squeeze_excitation_layer(net, int(512 * width_multiplier), 8)


                net_1_1=slim.convolution2d(net_512_1, round(128 * width_multiplier), [1, 1], padding='SAME')
                net_1_1 = slim.convolution2d(net_1_1, round(512 * width_multiplier), [1, 1], padding='SAME',activation_fn=None)
                ...
                net_1_2= slim.convolution2d(net_1_2, round(512 * width_multiplier), [1, 1], padding='SAME',activation_fn=None)
                net_1_3=tf.add_n([net_1_1,net_1_2])
                net=tf.add_n([net_512_1+net_1_3])
                net_512_1=tf.nn.relu6(net)

                net_1_1 = slim.convolution2d(net_512_1, round(128 * width_multiplier), [1, 1], padding='SAME')
                net_1_1 = slim.convolution2d(net_1_1, round(512 * width_multiplier), [1, 1], padding='SAME',
                                             activation_fn=None)

                net_1_2 = slim.convolution2d(net_512_1, round(128 * width_multiplier), [1, 1], padding='SAME')
                net_1_2 = _depthwise_separable_conv(net_1_2, 128, width_multiplier, sc='conv_ds_9')
                net_1_2 = _squeeze_excitation_layer(net_1_2, int(128 * width_multiplier), 8)
                net_1_2 = slim.convolution2d(net_1_2, round(512 * width_multiplier), [1, 1], padding='SAME',
                                             activation_fn=None)
                net_1_3 = tf.add_n([net_1_1, net_1_2])
                net = tf.add_n([net_512_1 + net_1_3])
                net_512_1 = tf.nn.relu6(net)
                ...
                net_1_2 = slim.convolution2d(net_512_1, round(128 * width_multiplier), [1, 1], padding='SAME')
                net_1_2 = _depthwise_separable_conv(net_1_2, 128, width_multiplier, sc='conv_ds_12')
                net_1_2 = _squeeze_excitation_layer(net_1_2, int(128 * width_multiplier), 8)
                net_1_2 = slim.convolution2d(net_1_2, round(512 * width_multiplier), [1, 1], padding='SAME',
                                             activation_fn=None)
                net_1_3 = tf.add_n([net_1_1, net_1_2])
                ...
                net_768_1 = _squeeze_excitation_layer(net, int(768 * width_multiplier), 8)

                net_1_1 = slim.convolution2d(net_768_1, round(256 * width_multiplier), [1, 1], padding='SAME')
                net_1_1 = slim.convolution2d(net_1_1, round(768 * width_multiplier), [1, 1], padding='SAME',
                                             activation_fn=None)

                net_1_2 = slim.convolution2d(net_768_1, round(256 * width_multiplier), [1, 1], padding='SAME')
                net_1_2 = _depthwise_separable_conv(net_1_2, 256, width_multiplier, sc='conv_ds_14')
                net_1_2 = _squeeze_excitation_layer(net_1_2, int(256 * width_multiplier), 8)
                net_1_2 = slim.convolution2d(net_1_2, round(768 * width_multiplier), [1, 1], padding='SAME',
                                             activation_fn=None)
                net_1_3 = tf.add_n([net_1_1, net_1_2])
                net = tf.add_n([net_768_1 + net_1_3])
                net = tf.nn.relu6(net)

                net = _depthwise_separable_conv(net, 1024, width_multiplier, sc='conv_ds_15')
...
if __name__ == '__main__':
    ...
    inputs = tf.placeholder(dtype=tf.float32, shape=[1,96,96,3])
    inference(inputs, 0,bottleneck_layer_size=256)
